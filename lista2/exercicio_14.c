/*copie os elementos de uma matriz 3x3 para outra matriz.*/
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
#define COL_SIZE 3
...
int main(){
    int matriz[LIN_SIZE][COL_SIZE], matriz_copy[LIN_SIZE][COL_SIZE];
    ...
    printf("a matrizes  copiadas são \n");
    print_matriz(matriz_copy[LIN_SIZE][COL_SIZE]);
